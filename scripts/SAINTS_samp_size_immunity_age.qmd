---
title: "SAINTS Sample Size: Immunity by age"
author: "Helen Dale"
date: "22/10/2022"
format: pdf
output-file: "SAINTS_SampleSize_Immunity_age.pdf"
editor: source
bibliography: SAINTS_sampsi_references.bib
...
-   SBA (log10 change in STm cfu/ml) standard deviation $\sigma_{SBA}=0.4-0.6$; based on [@nyirendaSequentialAcquisitionCells2014, Fig. 4C]

-   SBA average slope with age (in months) for Malawian children aged 9-36 months $\beta=\approx-0.1$; based on [@nyirendaSequentialAcquisitionCells2014, text p.61 & Fig. 4C]
...
-   Malaria prevalence in Southern Malawi: $p_{mal}=26\%$ (children 6-60 months; [@MalariaIndicatorSurvey2017, p.43 Fig 4.4]
...
Below is an example of the simulated data. \tiny
...
While 0.25 may seem quite a subtle effect, it is worth considering that that is less than the effect of aging by 3 months. \tiny
...
Considering the following diagram about direct, indirect, overall and total vaccine effects [@shimDistinguishingVaccineEfficacy2012]:
...
-   Malaria RTS,S/AS01 VE in children 5-17 months, 18 months after vaccination = 42-50% [@therts2014efficacysafetyrts]. This is the direct VE.
...
Power is reduced. However we still reach just about 80% power for large effects of malaria infection on SBA (1 unit change) and assuming 50% vaccine efficacy of RTS,S/AS01. While this is an exploratory aim, we have still adequate power for the upper end of realistic scenarios. \tiny
...
-   Minimum power 80%.
    ...
    -   Antibody titer standard deviation $\sigma_{SBA}=30$; based on [@nyirendaSequentialAcquisitionCells2014, Fig. 4C]

-   Antibody titer average slope with age (in months) for Malawian children aged 9-36 months $\beta=\approx30$; based on [@nyirendaSequentialAcquisitionCells2014, text p.61 & Fig. 4C]
