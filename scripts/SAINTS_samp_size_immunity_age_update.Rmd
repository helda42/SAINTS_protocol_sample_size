---
title: "SAINTS - Sample size / power calculation - immunity with age"
author: "Helen Dale & Marc Henrion"
date: "20/10/2022"
output: pdf_document
    code_folding: hide
---
...
datPowMalVacc <- import(here("data", "datPowMalVacc.RData"))

```

Considering the following diagram about direct, indirect, overall and total vaccine effects:
...
* Vaccination coverage in the vaccine cluster is 60%
...
* Indirect effect: Assumption this is 10% 
...
datPow <- import(here("data", "DawPowMalInf_Ab2.RData"))
